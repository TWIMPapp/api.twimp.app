...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    const { creator_id: body_creator_id, theme, name, start_location, pins, mode, competitive, hot_cold, settings: bodySettings, count, has_questions, spawn_radius } = req.body;
